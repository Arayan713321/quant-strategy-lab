...
def main():
    ...
    print("=" * 72)
    print("\n[EXPORT] Structured Quantitative Artifacts Generated Successfully:")
    print(" [CSV] Baseline Performance Curve  : ./results/baseline_equity_curve.csv")
    print(" [CSV] Baseline Trade Ledger Logs  : ./results/baseline_trade_log.csv")
    print(" [CSV] Baseline Summary Metrics    : ./results/baseline_metrics.csv")
    print(" [CSV] Walk-Forward Results Table  : ./results/walk_forward_results.csv")
    print(" [CSV] Parameter Sensitivity Matrix : ./results/parameter_sensitivity.csv")
    print(" [TXT] Multi-Factor Audit Summary  : ./results/robustness_report.txt")
    print(" [JSON] Quantitative Scorecard JSON: ./results/robustness_score.json")
    print(" [PNG] Baseline Performance Chart  : ./charts/baseline_performance.png")
    print(" [PNG] Walk-Forward Summary Plot   : ./charts/walk_forward_summary.png")
    print("========================================================================\n")
